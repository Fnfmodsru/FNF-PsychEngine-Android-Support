function onCreate()
	-- background shit
	makeLuaSprite('bg city', 'ice cream/bg city', -320, 100);
	
	makeLuaSprite('truck inside', 'ice cream/truck inside', -680, 100);

	makeLuaSprite('truck wall', 'ice cream/truck wall', -700, -100);
