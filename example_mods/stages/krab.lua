...
function onCreate()
	...
	makeLuaSprite('money_offer_bg', 'bob sponge/money_offer_bg', -1000, -500);
	addLuaSprite('money_offer_bg', false);
	scaleObject('money_offer_bg', 0.8, 0.8);

	makeLuaSprite('picture 1', 'bob sponge/picture 1', -300, 100);
	addLuaSprite('picture 1', false);
	scaleObject('picture 1', 0.8, 0.8);

	makeLuaSprite('picture 2', 'bob sponge/picture 2', 100, 70);
	addLuaSprite('picture 2', false);
	scaleObject('picture 2', 0.8, 0.8);

	makeLuaSprite('picture 3', 'bob sponge/picture 3', 1300, 50);
	addLuaSprite('picture 3', false);
	scaleObject('picture 3', 0.8, 0.8);

	makeLuaSprite('picture 4', 'bob sponge/picture 4', 1000, 100);
	addLuaSprite('picture 4', false);
	scaleObject('picture 4', 0.8, 0.8);

	makeLuaSprite('picture 5', 'bob sponge/picture 5', -650, 120);
	addLuaSprite('picture 5', false);
	scaleObject('picture 5', 0.8, 0.8);

    precacheImage('bob sponge/cooloutline');
	makeLuaSprite('theblack', 'bob sponge/cooloutline', 0, 0);
	setProperty('theblack.alpha', '0');
	setObjectCamera('theblack', 'other');

    precacheImage('bob sponge/Red_Pulse');
	makeAnimatedLuaSprite('thered', 'bob sponge/Red_Pulse', 0, 0);
